...
$.ajax({
	...
	success		: 	function(data)
	{
		 var jsonvars				=	JSON.parse(data);
			...
			{
				newRow[0] = jsonvars[index].email;
				newRow[1] = jsonvars[index].name;
				newRow[2] = jsonvars[index].gender
				newRow[3] = '<img src='+jsonvars[index].profilepic+'style="height :200px">';
				newRow[4] = jsonvars[index].date;
				newRow[5] = jsonvars[index].profession;
				newRow[6] = jsonvars[index].organization;
				newRow[7] = jsonvars[index].phonenumber;
                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
							...
							<li class="active">
								<a href="general1.jsp" style="color: white;">
                        ...
                        <div class="content">
                            <div class="module">
                                <div class="module-head">
                                    <h3>
                                        Total users Enrolled</h3>
                                </div>
                                <div class="module-body table">
                                <table id="entry" class="datatable-1 table table-bordered table-striped display" cellspacing="0" width="100%" style="width: 100% !important;">
	                    <thead>
